...
<html>
	...
	<body>
        ...
        <div class="container py-3">
            <div class="row">
                <div class="col-lg-2">
                    <h5 class="h6 pb-5">管理员：manager</h5>
                    <ul>
                        <li>
                            <h4>客户管理</h4>
                    ...
                    <ul>
                        <li>
                            <h4>员工管理</h4>
                            <ul class="pt-2 list-unstyled">
                                <li><a class="text-decoration-none text-dark" href="admin_goods/addmanager.php" target="mainFrame">添加员工</a></li>
                                <li><a class="text-decoration-none text-dark" href="admin_order/orderList.php" target="mainFrame">员工列表</a></li>
                            </ul>
                        </li>
                    </ul>
                    <ul>
